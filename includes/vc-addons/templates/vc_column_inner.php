<?php 
	...
	<div class="vu_column-inner<?php housico_extra_class($atts['el_class']); ?>"<?php echo ($atts['css_animation'] != 'none' && $atts['css_animation'] != '') ? ' data-animation="'. esc_attr($atts['css_animation']) .'"' . (($atts['animation_delay'] > 0) ? ' data-delay="'. $atts['animation_delay'] .'"' : '') : ''; ?>>
