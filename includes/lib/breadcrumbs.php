...
function housico_breadcrumbs() {
	...
	/* === OPTIONS === */
	$text['home']     = esc_html__('Home', 'housico'); // text for the 'Home' link
	$text['shop']     = esc_html__('Shop', 'housico'); // text for the 'Shop' link
	$text['category'] = esc_html__("All posts from '%s' category", 'housico'); // text for a category page
	$text['search']   = esc_html__('Search Results for "%s" Query', 'housico'); // text for a search results page
	$text['tag']      = esc_html__("All posts tagged with '%s'", 'housico'); // text for a tag page
	$text['author']   = esc_html__('Posts by %s', 'housico'); // text for an author page
	$text['404']      = esc_html__('Error 404', 'housico'); // text for the 404 page
	$text['page']     = esc_html__('Page %s', 'housico'); // text 'Page N'
	$text['cpage']    = esc_html__('Comment Page %s', 'housico'); // text 'Comment Page N'
	...
	if ( is_home() || is_front_page() ) {
		...
		if ($show_home_link == 1) {
			if ( function_exists('housico_is_woocommerce') and housico_is_woocommerce() ) {
