<article id="post-<?php the_ID(); ?>" <?php post_class('vu_blog-post vu_bp-type-image'); ?> itemscope="itemscope" itemtype="https://schema.org/BlogPosting">
	...
	<div class="vu_bp-content-wrapper">
		...
		<div class="vu_bp-content">
			<?php if( !is_single() ) : ?>
				...
				<div class="clear"></div>
				<a href="<?php echo esc_url( get_permalink() ); ?>" class="vu_bp-read-more"><?php echo esc_html__('Read More', 'housico'); ?></a>
			<?php else : ?>
